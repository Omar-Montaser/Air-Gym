...
('adminpwd5', 'Omar', 'Tarek', '01066554422', 'Male', '1988-03-17', 'Admin'),   
...
INSERT INTO Branch (Name, Location, OpeningDate, Status, AdminID) VALUES
('AirGym Haram', '44 Haram St., Below National Bank of Egypt, Giza', '2018-01-01', 'Active', 1),
('AirGym 6th of October', 'Central Spine, Magda Sq., Inside La Cite Mall, 6th of October, Giza', '2019-03-15', 'Active', 2),
('AirGym Maadi', '1 Block 61, Badr Towers, 10th Sector, Near To Marasy Seafood, Maadi, Cairo', '2020-06-10', 'Active', 3),
('AirGym Nasr City', '5 Al Nasr Street, Nasr City, Cairo', '2021-09-20', 'Active', 4),
('AirGym Heliopolis', '104 Othman Ibn Affan St., Next to QNB Bank & Faragalla Market, Heliopolis, Cairo', '2022-11-05', 'Active', 5);
...
('Basic', 'Access to gym equipment during staffed hours.', 1, 500.00, 0, 0, 0, 0, '#HND300'),
('Standard', 'Includes group classes and extended hours access.', 2, 750.00, 5, 0, 1, 1, '#NNH299'),
('Premium', 'All-access pass with personal trainer sessions.', 3, 1200.00, 10, 1, 2, 1, '#CHS675'),
('VIP', 'Exclusive access to all facilities and events with unlimited personal trainer sessions.', 4, 2000.00, 20, 1, 3, 1, '#KDN688');
...
(10, 4, '2025-01-01', '2025-03-31', 0, 1, 6, 'Active'),
...
('Membership', 12, 'DebitCard', '2025-02-15 15:00:00', 750.00, 'Completed'),
('Membership', 11, 'Cash', '2025-03-01 11:30:00', 1200.00, 'Cancelled'),
('expense', 10, 'CreditCard', '2025-05-01 17:00:00', 100.00, 'Cancelled'),
('expense', 11, 'Cash', '2025-05-02 17:30:00', 100.00, 'Completed');


INSERT INTO Booking (UserID, SessionID, Status, BookingDate) VALUES
(10, 1, 'Confirmed', '2025-05-01 12:00:00'),
(11, 2, 'Confirmed', '2025-05-02 13:00:00'),
(12, 3, 'Cancelled', '2025-05-03 14:00:00'),
(10, 5, 'Cancelled', '2025-05-04 15:00:00');